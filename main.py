...
SYMBOLS = [
    ...
    'TRX/USDT', 'BCH/USDT', 'NEAR/USDT', 'POL/USDT', 'UNI/USDT', 'ICP/USDT',
    'FIL/USDT', 'APT/USDT', 'XMR/USDT', 'LDO/USDT', 'HBAR/USDT', 'IMX/USDT',
    'ARB/USDT', 'OP/USDT', 'RENDER/USDT', 'ATOM/USDT', 'GRT/USDT', 'STX/USDT',
    'RUNE/USDT', 'INJ/USDT', 'S/USDT', 'VET/USDT', 'MKR/USDT', 'SEI/USDT',
    'SILVER(XAG)/USDT', 'GOLD(XAUT)/USDT', 'ENA/USDT', 'WIF/USDT', 'PEPE/USDT', 'FLOKI/USDT',
